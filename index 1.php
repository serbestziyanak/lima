...
FROM 
	tb_birim_sayfalari
WHERE 
	aktif = 1 AND harici = 0 AND birim_id = ?
ORDER BY sira
SQL;
...
FROM 
	tb_birim_sayfalari
WHERE 
	aktif = 1 AND harici = 0 AND birim_id = 1 AND ust_id = ?
ORDER BY sira
SQL;
...
SELECT * FROM ust_kategoriler ORDER BY id;
SQL;
...
<base href="/" />
    ...
    if($sayfa_id == 51){
        ?>
        <script type="text/javascript" src="https://ayu.edu.kz/wp-content/themes/smarty/assets/js/vendor/owl-carousel/owl.carousel.min.js?ver=3.0" id="owl-carousel-js"></script>    
        <?php
    }
    ?>
</head>
                    ...
                    <div class="header-top">
                        <div class="header-top-left">
                            <ul class="header-info">
                                <li><a href=""><?php echo dil_cevir( "AVESİS", $dizi_dil, $_REQUEST["dil"] ); ?></a></li>
                                <li><a href=""><?php echo dil_cevir( "Öğrenci", $dizi_dil, $_REQUEST["dil"] ); ?></a></li>
                                <li><a href=""><?php echo dil_cevir( "Mezun", $dizi_dil, $_REQUEST["dil"] ); ?></a></li>
                                <li><a href=""><?php echo dil_cevir( "Kalite", $dizi_dil, $_REQUEST["dil"] ); ?></a></li>
                                <li><a href=""><?php echo dil_cevir( "Portal", $dizi_dil, $_REQUEST["dil"] ); ?></a></li>
                                <li><a href=""><?php echo dil_cevir( "Kütüphane", $dizi_dil, $_REQUEST["dil"] ); ?></a></li>
                                <li><a href=""><?php echo dil_cevir( "Radyo", $dizi_dil, $_REQUEST["dil"] ); ?></a></li>
                            </ul>
                        ...
                        <div class="header-top-right">
                            <ul class="header-info">
                                ...
                                <li class="social-icon">
                                    <?php if( $sayfa_id>0 ){ ?>
                                    <a style="<?php if( $_REQUEST['dil'] == "kz" )echo "color:#cd201f"; ?>" href="kz/<?php echo $sayfa_id;?>/<?php echo $_REQUEST['sayfa_kisa_ad']; ?>">KZ</a>
                                    <a style="<?php if( $_REQUEST['dil'] == "tr" )echo "color:#cd201f"; ?>" href="tr/<?php echo $sayfa_id;?>/<?php echo $_REQUEST['sayfa_kisa_ad']; ?>">TR</a>
                                    <a style="<?php if( $_REQUEST['dil'] == "en" )echo "color:#cd201f"; ?>" href="en/<?php echo $sayfa_id;?>/<?php echo $_REQUEST['sayfa_kisa_ad']; ?>">EN</a>
                                    <a style="<?php if( $_REQUEST['dil'] == "ru" )echo "color:#cd201f"; ?>" href="ru/<?php echo $sayfa_id;?>/<?php echo $_REQUEST['sayfa_kisa_ad']; ?>">RU</a>
                                    <?php }else{ ?>
                                    <a style="<?php if( $_REQUEST['dil'] == "kz" )echo "color:#cd201f"; ?>" href="kz/">KZ</a>
                                    <a style="<?php if( $_REQUEST['dil'] == "tr" )echo "color:#cd201f"; ?>" href="tr/">TR</a>
                                    <a style="<?php if( $_REQUEST['dil'] == "en" )echo "color:#cd201f"; ?>" href="en/">EN</a>
                                    <a style="<?php if( $_REQUEST['dil'] == "ru" )echo "color:#cd201f"; ?>" href="ru/">RU</a>
                                    <?php } ?>
                                    ...
                                    <li class="has-droupdown"><a href="<?php echo $actual_link; ?>#" ><?php echo $birim_sayfa_bir['adi'.$dil]; ?></a>
                                                        ...
                                                        if( $birim_sayfa_bir['kisa_ad'] == 'akademik' ){
                                                            ...
                                                            echo "<li><h6 style='color:#eb0023;margin-top:10px;margin-bottom:0px;'>$birim[$adi]</h6><ul class='submenu'>";
                                                                ...
                                                                @$akademik_birimler2 = $vt->select($SQL_akademik_birimler, array( $birim['id'] ) )[ 2 ];
                                                                foreach(@$akademik_birimler2 as $birim2){
                                                                echo "<li><a href='birimler/$_REQUEST[dil]/$birim2[kisa_ad]'>$birim2[$adi]</a></li>";
                                                                } 
                                                            echo "</ul></li>";
                                                            }
                                                            echo "</ul></li>";
                                                            ...
                                                            foreach( @$akademik_birimler as $birim ){
                                                                echo "<li><a href='birimler/$_REQUEST[dil]/$birim[kisa_ad]'>$birim[$adi]</a></li>";
                                                            }
                                                            echo "</ul></li></ul>";
                                                        }else{
                                                        ?>
...
?>
                                ...
                                <div class="row">
                                    <div class="col-7">
                                        <div class="banner-content">
                                            ...
                                            <h1 class="title" data-sal-delay="100" data-sal="slide-up" data-sal-duration="1000"><?php echo $slayt['baslik2'.$dil] ?></h1>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="about-edu" role="tabpanel">
                                    ...
                                    <ul class="features-list">
                                        <li><?php echo dil_cevir( "Köklü Geçmişten Güçlü Geleceğe", $dizi_dil, $sistem_dil ); ?></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
        ...
        <div class="edu-cta-banner-area course-area-3 section-gap-large bg-lighten04 section_ust_bilgi_bosluk">
            <div class="container">
                <div class="section-title section-center" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <h2 class="title"><?php echo dil_cevir( "Duyurular", $dizi_dil, $sistem_dil ); ?> & <?php echo dil_cevir( "Etkinlikler", $dizi_dil, $sistem_dil ); ?></h2>
                    <span class="shape-line"><i class="icon-19"></i></span>
                </div>
                <div class="isotope-wrapper">
                    <div class="isotop-button isotop-filter">
                        <button data-filter=".duyurular" class="is-checked" id="asdf">
                            <span class="filter-text"><?php echo dil_cevir( "Duyurular", $dizi_dil, $sistem_dil ); ?></span>
                        </button>
                        <button data-filter=".haberler">
                            <span class="filter-text"><?php echo dil_cevir( "Haberler", $dizi_dil, $sistem_dil ); ?></span>
                        </button>
                        <button data-filter=".etkinlikler">
                            <span class="filter-text"><?php echo dil_cevir( "Etkinlikler", $dizi_dil, $sistem_dil ); ?></span>
                        </button>
                    </div>
                    <div class="row g-5 isotope-list">
                        ...
                        <div class="col-md-6 col-lg-4 isotope-item duyurular">
                            <div class="edu-course course-style-3" data-sal-delay="100" data-sal="slide-up" data-sal-duration="800">
                                <div class="inner">
                                    <div class="thumbnail">
                                        <a href="#">
                                            <img src="admin/resimler/duyurular/<?php echo $duyuru['foto']; ?>" alt="Course Meta" style="object-fit: cover; height: 250px; ">
                                        </a>
                                        <div class="time-top">
                                    ...
                                    <div class="content">
                                        ...
                                        <h5 class="title" style="font-size:13px;">
                                            <a href="#"><?php echo $duyuru['baslik'.$dil] ?></a>
                                        </h5>
                                        ...
                                        <div class="read-more-btn">
                                            <a class="edu-btn btn-small btn-secondary" href="#"><?php echo dil_cevir( "Daha Fazla", $dizi_dil, $_REQUEST["dil"] ); ?> <i class="icon-4"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 col-lg-12 isotope-item duyurular">
                            <div class="event-view-all-btn" data-sal-delay="150" data-sal="slide-up" data-sal-duration="1200">
                                <h6 class="view-text"><?php echo dil_cevir( "Tüm duyurular için ", $dizi_dil, $_REQUEST["dil"] ); ?> <a href="<?php echo $_REQUEST["dil"]."/tum_duyurular"; ?>" class="btn-transparent">tıklayınız <i class="icon-4"></i></a></h6>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-4 isotope-item haberler">
                            <div class="edu-course course-style-3" data-sal-delay="100" data-sal="slide-up" data-sal-duration="800">
                                <div class="inner">
                                    <div class="thumbnail">
                                        <a href="#">
                                            <img src="admin/resimler/haberler/<?php echo $haber['foto']; ?>" alt="Course Meta" style="object-fit: cover; height: 250px;; ">
                                        </a>
                                        <div class="time-top">
                                    ...
                                    <div class="content">
                                        ...
                                        <h5 class="title" style="font-size:13px;">
                                            <a href="#"><?php echo $haber['baslik'.$dil] ?></a>
                                        </h5>
                                        <div class="course-rating">
                                            <div class="rating">
                                                <i class="icon-23"></i>
                        ...
                        <div class="col-md-6 col-lg-12 isotope-item haberler">
                            <div class="event-view-all-btn" data-sal-delay="150" data-sal="slide-up" data-sal-duration="1200">
                                <h6 class="view-text"><?php echo dil_cevir( "Tüm haberler için ", $dizi_dil, $_REQUEST["dil"] ); ?> <a href="<?php echo $_REQUEST["dil"]."/tum_haberler"; ?>" class="btn-transparent">tıklayınız <i class="icon-4"></i></a></h6>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-4 isotope-item etkinlikler asd">
                            <div class="edu-course course-style-3" data-sal-delay="100" data-sal="slide-up" data-sal-duration="800">
                                <div class="inner">
                                    <div class="thumbnail">
                                        <a href="#">
                                            <img src="admin/resimler/etkinlikler/<?php echo $etkinlik['foto']; ?>" alt="Course Meta" style="object-fit: cover; height: 250px;; ">
                                        </a>
                                        <div class="time-top">
                                    ...
                                    <div class="content">
                                        ...
                                        <h5 class="title" style="font-size:13px;">
                                            <a href="#"><?php echo $etkinlik['baslik'.$dil] ?></a>
                                        </h5>
                                        <div class="course-rating">
                                            <div class="rating">
                                                <i class="icon-23"></i>
                        ...
                        <div class="col-md-6 col-lg-12 isotope-item etkinlikler">
                            <div class="event-view-all-btn" data-sal-delay="150" data-sal="slide-up" data-sal-duration="1200">
                                <h6 class="view-text"><?php echo dil_cevir( "Tüm etkinlikler için ", $dizi_dil, $_REQUEST["dil"] ); ?> <a href="<?php echo $_REQUEST["dil"]."/tum_etkinlikler"; ?>" class="btn-transparent">tıklayınız <i class="icon-4"></i></a></h6>
                            </div>
                        </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6 col-md-8">
                        <div class="video-banner-content">
                            ...
                            <h2 class="title"><?php echo dil_cevir( "Ahmet Yesevi Üniversitesi Tanıtım Videosu", $dizi_dil, $sistem_dil ); ?></h2>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="edu-cta-box cta-style-2 bg-image bg-image--9">
                            <div class="inner">
                                <div class="content text-end">
                                    <span class="subtitle"><?php echo dil_cevir( "Bize yazın", $dizi_dil, $sistem_dil ); ?>:</span>
                                    <h3 class="title"><a href="mailto:info@ayu.edu.kz">info@ayu.edu.kz</a></h3>
                                </div>
                                <div class="sparator">
                                    <span><?php echo dil_cevir( "veya", $dizi_dil, $sistem_dil ); ?></span>
                                </div>
                                <div class="content">
                                    <span class="subtitle"><?php echo dil_cevir( "Bizi arayın", $dizi_dil, $sistem_dil ); ?>:</span>
                    ...
                    <div class="row g-5">
                        <div class="col-lg-3 col-md-6">
                            <div class="edu-footer-widget">
                                ...
                                <p class="description"><?php echo dil_cevir( "Türk dünyasının parlayan yıldızı", $dizi_dil, $sistem_dil ); ?></p>
                                <div class="widget-information">
                                    <ul class="information-list">
                                        <li><span><?php echo dil_cevir( "Adres", $dizi_dil, $sistem_dil ); ?>:</span><?php echo $genel_ayarlar['adres'.$dil] ?></li>
                                        <li><span><?php echo dil_cevir( "Tel", $dizi_dil, $sistem_dil ); ?>:</span><a href="tel:+011235641231"><?php echo $genel_ayarlar['tel'] ?></a></li>
                                        <li><span><?php echo dil_cevir( "Email", $dizi_dil, $sistem_dil ); ?>:</span><a href="mailto:info@edublink.com" target="_blank"><?php echo $genel_ayarlar['email'] ?></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="edu-footer-widget quick-link-widget">
                                <h4 class="widget-title"><?php echo dil_cevir( "Fakülteler", $dizi_dil, $sistem_dil ); ?></h4>
                                <div class="inner">
                                    <ul class="footer-link link-hover">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="edu-footer-widget">
                                <h4 class="widget-title"><?php echo dil_cevir( "Lokasyon", $dizi_dil, $sistem_dil ); ?></h4>
                                <div class="inner">
