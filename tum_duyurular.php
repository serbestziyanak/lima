        ...
        <div class="container">
            <div class="breadcrumb-inner">
                <ul class="edu-breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><?php echo dil_cevir( "Tüm Duyurular", $dizi_dil, $_REQUEST["dil"] ); ?></li>
                </ul>
                <div class="page-title">
                    <h1 class="title"><?php echo dil_cevir( "Tüm Duyurular", $dizi_dil, $_REQUEST["dil"] ); ?></h1>
                </div>
            ...
            <div class="row row--30">
                <div class="col-lg-8">
                    <table id="example" style="width:100%;border:0px;">
                            ...
                            <tbody>
                                <?php $sira = 0; foreach( $duyurular as $duyuru ){ $sira++; ?>
                                <tr>
                                    <td style="border:0px;"><?php echo $sira; ?></td>
                                    <td style="border:0px;"><span style="display:none;"><?php echo $duyuru['tarih']; ?></span><?php echo $fn->tarihVer($duyuru['tarih']); ?></td>
                                    <td style="border:0px;"><a href="<?php echo $_REQUEST['dil']."/duyurular/".$duyuru['id'] ?>"><img src="admin/resimler/duyurular/kucuk/<?php echo $duyuru['foto']; ?>"></a></td>
                                    <td style="border:0px;"><a href="<?php echo $_REQUEST['dil']."/duyurular/".$duyuru['id'] ?>"><?php echo $duyuru['baslik'.$dil]; ?> </a></td>
                                </tr>
                                <?php } ?>
                    ...
                    <div class="course-sidebar-3 sidebar-top-position">
                        <div class="edu-course-widget widget-course-summery">
                            <div class="inner">
                                ...
                                <div class="content">
                                    <h4 class="widget-title" style="color:#cd201f"><?php echo dil_cevir( "Tüm Duyurular", $dizi_dil, $_REQUEST["dil"] ); ?>:</a></h4>
