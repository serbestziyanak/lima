...
$dil	 			= array_key_exists( 'tab_dil', $_REQUEST ) 	? $_REQUEST[ 'tab_dil' ] : "";
$dil	 			= $dil == "_tr" ? "" : $dil;
...
$SQL_max_sira = <<< SQL
SELECT max(sira) as max_sira from  tb_birim_sayfa_icerikleri_tabs where birim_id = ? and sayfa_id = ? and dil_id = ?
SQL;
