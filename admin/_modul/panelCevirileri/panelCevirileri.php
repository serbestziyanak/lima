	...
	<div class="modal fade" id="ceviri_ekle" modul= 'birimSayfalari' yetki_islem='duzenle' >
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form class="form-horizontal" action = "_modul/panelCevirileri/panelCevirileriSEG.php" method = "POST">
					<div class="modal-body">
				...
				<div class="card card-secondary">
					<div class="card-header">
						...
						<div class = "card-tools">
							...
							<a data-toggle="modal" data-target="#ceviri_ekle" title = "Çeviri" href = "?modul=panelCevirileri&islem=ekle" class="btn btn-tool" ><i class="fas fa-plus fa-lg"></i></a>
						</div>
					</div>
					<div class="card-body">
						<div class="tab-content">
							...
							<div class="tab-pane active" id="_genel">
								<form class="form-horizontal" action = "_modul/panelCevirileri/panelCevirileriSEG.php" method = "POST" enctype="multipart/form-data">
									...
									<div class="card-footer">
										<button modul= 'panelCevirileri' yetki_islem="kaydet" type="submit" class="<?php echo $kaydet_buton_cls; ?>"><span class="fa fa-save"></span> <?php echo $kaydet_buton_yazi; ?></button>
									</div>
								</form>
							</div>
						</div>
