...
switch( $islem ) {
	case 'ekle':
        ...
        if( isset( $_REQUEST['galeri'] ) ){
            $galeri_dizin = "../../resimler/duyurular/";
	...
	case 'foto_sil':
        ...
        if( $sorgu_sonuc[ 0 ] ){
            ...
            @unlink( "../../resimler/duyurular/buyuk/".$_REQUEST['foto'] );
            @unlink( "../../resimler/duyurular/kucuk/".$_REQUEST['foto'] );
        }

        @$galeri = $vt->select( $SQL_galeri, array( $_REQUEST['duyuru_id'] ) )[ 2 ];
