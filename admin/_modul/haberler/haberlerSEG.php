...
if( isset($_FILES["foto"]) ){
	...
	//header( "Location:../../index.php?modul=haberler&birim_id=".$_REQUEST['birim_id']."&birim_adi=".$_REQUEST['birim_adi']);
	//exit;
	}
}
...
switch( $islem ) {
	case 'ekle':
        ...
        if( isset( $_REQUEST['galeri'] ) ){
            $galeri_dizin = "../../resimler/haberler/";
	...
	case 'foto_sil':
        ...
        if( $sorgu_sonuc[ 0 ] ){
            ...
            @unlink( "../../resimler/haberler/buyuk/".$_REQUEST['foto'] );
            @unlink( "../../resimler/haberler/kucuk/".$_REQUEST['foto'] );
        }

        @$galeri = $vt->select( $SQL_galeri, array( $_REQUEST['haber_id'] ) )[ 2 ];
...
header( "Location:../../index.php?modul=haberler&islem=guncelle&id=".$id."&birim_id=".$_REQUEST['birim_id']."&birim_adi=".$_REQUEST['birim_adi']);
?>