	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-8">
                <div class="row">
                    <div class="col-12 ">
                        <div class="card card-danger card-outline" id = "card_personel_buyruk_bilgileri">
                        ...
                        <div class="card card-olive" id = "card_personel_buyruk_bilgileri">
                            <div class="card-header">
                                ...
                                <div class = "card-tools">
                                    ...
                                    <a id = "yeni_fakulte" data-toggle = "tooltip" title = "Add" href = "?modul=personelBuyrukBilgileri&islem=ekle&personel_id=<?php echo $personel_id ?>" class="btn btn-tool" ><i class="fas fa-plus fa-lg"></i></a>
                                </div>
                            </div>
                            <div class="card-body">
                                <table id="tbl_personel_buyruk_bilgileri" class="table table-bordered table-hover table-sm" width = "100%" >
                                    ...
                                    <tbody>
                                        ...
                                        <tr oncontextmenu="fun();" class =" <?php if( $personel_buyruk_bilgi[ 'id' ] == $id ) echo $satir_renk; ?>" data-id="<?php echo $personel_buyruk_bilgi[ 'id' ]; ?>">
                                            ...
                                            <td align = "center">
                                                <a modul = 'personelBuyrukBilgileri' yetki_islem="duzenle" class = "btn btn-sm btn-warning btn-xs" href = "?modul=personelBuyrukBilgileri&islem=guncelle&personel_id=<?php echo $personel_buyruk_bilgi[ 'personel_id' ]; ?>&id=<?php echo $personel_buyruk_bilgi[ 'id' ]; ?>" >
                                                    <?php echo dil_cevir( "Düzenle", $dizi_dil, $sistem_dil ); ?>
                                                </a>
                                            </td>
                                            <td align = "center">
                                                <button modul= 'personelBuyrukBilgileri' yetki_islem="sil" class="btn btn-xs btn-danger" data-href="_modul/personelBuyrukBilgileri/personelBuyrukBilgileriSEG.php?islem=sil&personel_id=<?php echo $personel_buyruk_bilgi[ 'personel_id' ]; ?>&id=<?php echo $personel_buyruk_bilgi[ 'id' ]; ?>" data-toggle="modal" data-target="#sil_onay"><?php echo dil_cevir( "Sil", $dizi_dil, $sistem_dil ); ?></button>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
			...
			<div class="col-md-4">
				<form class="form-horizontal" action = "_modul/personelBuyrukBilgileri/personelBuyrukBilgileriSEG.php" method = "POST" enctype="multipart/form-data">
						...
						<div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group sabit card p-3">
                                    ...
                                    <br>
                                    <input  required type="file" class="" id ="belge" name ="belge"   >
                                </div>
						</div>
						<div class="card-footer">
							<button modul= 'personelBuyrukBilgileri' yetki_islem="kaydet" type="submit" class="<?php echo $kaydet_buton_cls; ?>"><span class="fa fa-save"></span> <?php echo dil_cevir( $kaydet_buton_yazi, $dizi_dil, $sistem_dil ); ?></button>
						</div>
					</div>
				</form>
			</div>
