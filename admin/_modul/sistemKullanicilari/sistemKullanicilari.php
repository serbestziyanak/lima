        ...
        <div class="row">
          <div class="col-md-8">
            <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title"><?php echo dil_cevir( "Sistem Kullanıcıları", $dizi_dil, $sistem_dil ); ?></h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
					...
					<thead>
						<tr class="">
							...
							<?php if( !$fn->mobilCihaz() ) { ?>
								<th><?php echo dil_cevir( "Kullanıcı Adı", $dizi_dil, $sistem_dil ); ?></th>
								<th><?php echo dil_cevir( "Rol", $dizi_dil, $sistem_dil ); ?></th>
							<?php } ?>
							...
							<th data-priority="1" style="width: 10px"><?php echo dil_cevir( "Süper", $dizi_dil, $sistem_dil ); ?></th>
						</tr>
					</thead>
					<tbody>
						...
						<tr <?php if( $kul[ 'id' ] == $sistem_kullanici_id ) echo "class = '$satir_renk'"; ?>>
							...
							<td align = "center">
								<button modul= 'sistemKullanicilari' yetki_islem="sil" class="btn btn-sm btn-danger btn-xs" data-href="_modul/sistemKullanicilari/sistemKullanicilariSEG.php?super=<?php echo $kul[ 'super' ]?>&islem=sil&id=<?php echo $kul[ 'id' ]; ?>" data-toggle="modal" data-target="#kullanici_sil_onay" ><?php echo dil_cevir( "Sil", $dizi_dil, $sistem_dil ); ?></button>
							</td>
          ...
          <div class="col-md-4">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title"><?php echo dil_cevir( "Sistem Kullanıcıları Ekle / Güncelle", $dizi_dil, $sistem_dil ); ?></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
				...
				<form class="form-horizontal" id = "kayit_formu" action = "_modul/sistemKullanicilari/sistemKullanicilariSEG.php" method = "POST" enctype="multipart/form-data">
					...
					<div class="form-group">
						<label  class="control-label"><?php echo dil_cevir( "TC Kimlik No", $dizi_dil, $sistem_dil ); ?></label>
					...
					<div class="form-group">
					  <label><?php echo dil_cevir( "GSM 1", $dizi_dil, $sistem_dil ); ?></label>
					...
					<div modul= 'sistemKullanicilari' yetki_islem="super" class="form-group">
						<div class='material-switch pull-right' style ="padding-top:10px">
							<label class="control-label"><?php echo dil_cevir( "Süper Kullanıcı", $dizi_dil, $sistem_dil ); ?></label>
