...
@$galeri        = $vt->select($SQL_galeri, array( $haber_id ) )[ 2 ];

@$haber_icerik = $vt->selectSingle($SQL_tek_haber, array( $haber_id ) )[ 2 ];
@$haberler = $vt->select($SQL_haberler, array( $birim_id ) )[ 2 ];

if( $haber_icerik['id'] < 1 ){
    header('Location: /404/');
}
        ...
        <div class="container">
            <div class="breadcrumb-inner">
                <ul class="edu-breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><?php echo dil_cevir( "Haberler", $dizi_dil, $_REQUEST["dil"] ); ?></li>
                </ul>
                <div class="page-title">
                    <h1 class="title"><?php echo dil_cevir( "Haberler", $dizi_dil, $_REQUEST["dil"] ); ?></h1>
                </div>
                ...
                <div class="col-lg-8">
                    <div class="course-details-content course-details-3">
                        ...
                        <div class="entry-content">
                            <h3 class="title"><?php echo $haber_icerik["baslik".$dil]; ?></h3>
                            <ul class="course-meta">
                                <li><i class="fa-regular fa-clock"></i><?php echo $fn->tarihVer($haber_icerik['tarih']); ?></li>
                                <li><i class="icon-59"></i><?php echo strtoupper($_REQUEST['dil']); ?></li>
                                <li class="course-rating">
                                    <div class="rating">
                                        <i class="icon-23"></i>
                            ...
                            <br>
                            <div >
                                <img src="admin/resimler/haberler/buyuk/<?php echo $haber_icerik["foto"]; ?>" alt="Course" style="border-radius: 10px;">
                            </div>
                        </div>
                        ...
                        <div class="container">
                            ...
                            <div id="masonry-gallery" class="gallery-grid-wrap">
                                <div id="animated-thumbnials">
                                    ...
                                    <a href="admin/resimler/haberler/buyuk/<?php echo $foto_galeri['foto']; ?>"   class="edu-popup-image edu-gallery-grid p-gallery-grid-wrap masonry-item">
                                        <div class="thumbnail">
                                            <img style="object-fit: cover;height: 180px;" src="admin/resimler/haberler/kucuk/<?php echo $foto_galeri['foto']; ?>" alt="Gallery Image">
                                        </div>
                                        <div class="zoom-icon">
                                            <i class="icon-69"></i>
                                        </div>
                    ...
                    <div class="course-sidebar-3 sidebar-top-position">
                        <div class="edu-course-widget widget-course-summery">
                            <div class="inner">
                                ...
                                <div class="content">
                                    <h4 class="widget-title" style="color:#cd201f"><?php echo dil_cevir( "Haberler", $dizi_dil, $_REQUEST["dil"] ); ?>:</a></h4>
                                    <ul class="course-item">
                                        <?php foreach( $haberler as $haber ){ ?>
                                        <li>
                                            <span class="label"><i class="fa-solid fa-circle-check" style="color:<?php if($haber['id'] == $haber_id) echo "#cd201f"; else echo "#2A8DA3"; ?>"></i><a href="<?php echo $_REQUEST['dil']."/haberler/".$haber['id'] ?>"><?php echo $haber['baslik'.$dil]; ?> </a></span>
