                ...
                <div class="col-xxl-8 col-lg-7">
                    <div class="th-blog blog-single" >
                        <div class="blog-img">
                            ...
                            ?>
                            <img src="../admin/resimler/duyurular/buyuk/<?php echo $duyuru_icerik['foto']; ?>" alt="Blog Image">
                            <?php } ?>
                        </div>
                        <div class="blog-content" style="min-height: 600px;">
                            <div class="blog-meta">
                                <a class="author" href="<?php echo $_REQUEST["dil"]."/".$duyuru_icerik['birim_kisa_ad']; ?>/"><i class="far fa-user"></i><?php echo @$duyuru_icerik['birim_adi'.$dil]; ?></a>
