                    ...
                    <div class="th-blog blog-single" >
                        ...
                        <div class="blog-content" style="min-height: 600px;">
                            <div class="blog-meta">
                                ...
                                <a href="blog.html"><i class="fa-light fa-calendar-days"></i><?php echo $fn->tarihVer($etkinlik_icerik['tarih']); ?></a>
                        ...
                        <div class="widget  ">
                            ...
                            <div class="recent-post-wrap">
                                ...
                                <div class="recent-post">
                                    <div class="media-img">
                                        <a href="<?php echo $_REQUEST['dil']; ?>/<?php echo $_REQUEST['kisa_ad']; ?>/duyurular/<?php echo $duyuru['id']; ?>"><img src="../admin/resimler/duyurular/<?php echo $duyuru_foto; ?>" alt="Blog Image"  style="width: 80px;height: 80px;object-fit: cover;"></a>
                                    </div>
