    ...
    <div class="breadcumb-wrapper " data-bg-src="assets/img/bg/2.jpg" data-overlay="title" data-opacity="8">
        ...
        <div class="container">
            <div class="breadcumb-content text-center">
                <h1 class="breadcumb-title" style="text-transform:none;"><?php echo dil_cevir( "Tüm Haberler", $dizi_dil, $_REQUEST["dil"] ); ?></h1>
                <ul class="breadcumb-menu">
                    <li><a href="<?php echo $_REQUEST['dil']."/".$_REQUEST['kisa_ad']; ?>"><?php echo dil_cevir( "Anasayfa", $dizi_dil, $_REQUEST["dil"] ); ?></a></li>
                    <li><?php echo dil_cevir( "Tüm Haberler", $dizi_dil, $_REQUEST["dil"] ); ?></li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="row gx-30">
                <div class="col-xxl-12 col-lg-12">
                    ...
                    <aside class="sidebar-area">
                        <div class="widget  ">
                            <h3 class="widget_title"><?php echo dil_cevir( "Tüm Haberler", $dizi_dil, $_REQUEST["dil"] ); ?></h3>
                            <div class="recent-post-wrap">
                                ...
                                <div class="recent-post">
                                    ...
                                    <div class="media-body">
                                        <h4 class="post-title" style="font-size: 12px;"><a class="text-inherit" href="<?php echo $_REQUEST["dil"]."/".$_REQUEST['kisa_ad']; ?>/haberler/<?php echo $haber['id']; ?>"><?php echo $haber['baslik'.$dil]; ?></a></h4>
                                        <div class="recent-post-meta">
                                            <small class="text-muted"><a href="<?php echo $_REQUEST["dil"]."/".$_REQUEST['kisa_ad']; ?>/haberler/<?php echo $haber['id']; ?>"><i class="fal fa-calendar"></i><?php echo $fn->tarihVer($haber['tarih']); ?></a></small>
                                        </div>
                                    </div>
                                </div>
                                <?php } ?>
