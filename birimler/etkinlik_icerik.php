            ...
            <div class="row gx-30">
                <div class="col-xxl-8 col-lg-7">
                    <div class="th-blog blog-single" >
                        <div class="blog-img">
                            <?php 
                                if( $etkinlik_icerik['foto'] != "" ){
                            ?>
                            <img src="../admin/resimler/etkinlikler/buyuk/<?php echo $etkinlik_icerik['foto']; ?>" alt="Blog Image">
                            <?php } ?>
                        </div>
                        <div class="blog-content" style="min-height: 600px;">
                            <div class="blog-meta">
                                <a class="author" href="<?php echo $_REQUEST["dil"]."/".$etkinlik_icerik['birim_kisa_ad']; ?>/"><i class="fa-solid fa-school"></i><?php echo @$etkinlik_icerik['birim_adi'.$dil]; ?></a>
                                <a><i class="fa-light fa-calendar-days"></i><?php echo $fn->tarihSaatVer($etkinlik_icerik['tarih']); ?></a>
                                <a><i class="fa-solid fa-location-dot"></i><?php echo $etkinlik_icerik['yeri'.$dil]; ?></a>
                                <!--a href="blog-details.html"><i class="fa-light fa-book"></i>Business Analysis</a-->
                            </div>
                            <h2 class="blog-title" style="font-size: 24px;"><?php echo @$etkinlik_icerik['baslik'.$dil]; ?></h2>
                        ...
                        <div class="widget  ">
                            ...
                            <div class="recent-post-wrap">
                                ...
                                <div class="recent-post">
                                    <div class="media-img">
                                        <a href="<?php echo $_REQUEST['dil']; ?>/<?php echo $_REQUEST['kisa_ad']; ?>/duyurular/<?php echo $duyuru['id']; ?>"><img src="../admin/resimler/duyurular/kucuk/<?php echo $duyuru_foto; ?>" alt="Blog Image"  style="width: 80px;height: 80px;object-fit: cover;"></a>
                                    </div>
