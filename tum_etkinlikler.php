        ...
        <div class="container">
            <div class="breadcrumb-inner">
                <ul class="edu-breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><?php echo dil_cevir( "Tüm Etkinlikler", $dizi_dil, $_REQUEST["dil"] ); ?></li>
                </ul>
                <div class="page-title">
                    <h1 class="title"><?php echo dil_cevir( "Tüm Etkinlikler", $dizi_dil, $_REQUEST["dil"] ); ?></h1>
                </div>
                    ...
                    <table id="example" style="width:100%;border:0px;">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Tarih</th>
                                    <th>Etkinlik Görsel</th>
                                    <th>Başlık</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php $sira = 0; foreach( $etkinlikler as $etkinlik ){ $sira++; ?>
                                <tr>
                                    <td style="border:0px;"><?php echo $sira; ?></td>
                                    <td style="border:0px;"><span style="display:none;"><?php echo $etkinlik['tarih']; ?></span><?php echo $fn->tarihVer($etkinlik['tarih']); ?></td>
                                    <td style="border:0px;"><a href="<?php echo $_REQUEST['dil']."/etkinlikler/".$etkinlik['id'] ?>"><img style="object-fit: cover; height: 100px;width:200px; " src="admin/resimler/etkinlikler/kucuk/<?php echo $etkinlik['foto']; ?>"></a></td>
                                    <td style="border:0px;"><a href="<?php echo $_REQUEST['dil']."/etkinlikler/".$etkinlik['id'] ?>"><?php echo $etkinlik['baslik'.$dil]; ?> </a></td>
                                </tr>
                                <?php } ?>
                    ...
                    <div class="course-sidebar-3 sidebar-top-position">
                        <div class="edu-course-widget widget-course-summery">
                            <div class="inner">
                                ...
                                <div class="content">
                                    <h4 class="widget-title" style="color:#cd201f"><?php echo dil_cevir( "Tüm Etkinlikler", $dizi_dil, $_REQUEST["dil"] ); ?>:</a></h4>
