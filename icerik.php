...
//echo "<pre>";var_dump( $sayfa_ust_bilgiler_dizi );echo "</pre>";
                        ...
                        <div class="container">
                            ...
                            <div id="masonry-gallery" class="gallery-grid-wrap">
                                <div id="animated-thumbnials">
                                    ...
                                    <a href="admin/resimler/sayfalar/buyuk/<?php echo $foto_galeri['foto']; ?>"   class="edu-popup-image edu-gallery-grid p-gallery-grid-wrap masonry-item">
                                        <div class="thumbnail">
                                            <img style="object-fit: cover;height: 180px;" src="admin/resimler/sayfalar/kucuk/<?php echo $foto_galeri['foto']; ?>" alt="Gallery Image">
                                        </div>
                                        <div class="zoom-icon">
                                            <i class="icon-69"></i>
                                        </div>
